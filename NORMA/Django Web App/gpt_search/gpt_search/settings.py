"""
Django settings for gpt_search project.
...
WSGI_APPLICATION = 'gpt_search.wsgi.application'
...
LOGIN_REDIRECT_URL = '/home/'  # Redirects authenticated users to the home page
